    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                <div class="container-fluid">
                    <?php
                    function date_conv_od($val)
                    {
                        $result = explode('-', $val);
                        return "$result[2]/$result[1]/$result[0]";
                    }
                    function date_conv_full($start_date, $end_date)
                    {
                        $result = date_conv_od($start_date) . "-" . date_conv_od($end_date);
                        return $result;
                    }
                    if (isset($_GET["id"])) {
                        $id = $_GET["id"];
                        require_once('api/date_range.php');
                        $result = get_date($id, $conn);
                        $row = $result->fetch_assoc();
                        $od_date = date_conv_full($row["ser_start_date"], $row["ser_end_date"]);
                    }
                    ?>
                    <!-- Form -->
                    <div class="card card-maroon">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-3">
                                    <div class="info-box">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span id="total_service" class="info-box-number h2"><?= $row["ser_total_days"] ?> วัน</span>
                                        </div>
                                        <!-- /.info-box-content -->
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="info-box">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span id="total_user" class="info-box-number h2"><?= $row["ser_user_per_day"] * $row["ser_total_days"] ?> คน</span>
                                        </div>
                                        <!-- /.info-box-content -->
                                    </div>
                                </div>
                            ...
                            <form action="src/date_edit_check.php?id=<?= $id ?>" method="post" class="needs-validation" novalidate>
                                <div class="row">
                                    <div class="col-12 col-md-12 col-lg-12">
                                        <div class="form-group">
                                            <label for="exampleInputBorderWidth2">หัวข้อบริการ</label>
                                            <select name="title" class="custom-select" id="" required>
                                                ...
                                                while ($row_o = $result->fetch_assoc()) {
                                                ?>
                                                    <option <?php if ($row["sd_id"] == $row_o["sd_id"]) echo "selected"; ?> value="<?= $row_o["sd_id"] ?>"><?= $row_o["st_type_name"] ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-6 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input value="<?= $od_date ?>" name="date_range" type="text" class="form-control float-right" id="reservation" name="datefilter" value="" placeholder="ตั้งแต่วันที่ - ถึงวันที่" required />
                                                <div class="input-group-prepend">
                                    ...
                                    <div class="col-12 col-md-4 col-lg-3 col-sm-12 d-none">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input value="<?= $row["ser_total_days"] ?>" name="total_day" type="text" class="form-control float-right" id="totaldays" name="datefilter" value="" placeholder="ระยะเวลา" required />
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">
                                                        วัน
                                                    </span>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input value="<?= $row["ser_user_per_day"] ?>" name="per_day" id="per_day" type="number" min='1' oninput="validity.valid||(value='');" class="form-control " id="exampleInputBorderWidth2" placeholder="กรุุณาป้อนจำนวนคนเข้าใช้บริการต่อวัน" required>
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">
                                                        คนต่อวัน
                                                    </span>
