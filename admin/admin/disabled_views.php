        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">จัดข้อมูลประเภทความพิการ</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="index.php">หน้าแรก</a></li>
                                <li class="breadcrumb-item active">จัดข้อมูลประเภทความพิการ</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                        ...
                        <div class="col-md-3 col-sm-12 col-12">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number"> คน</span>
                                </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-wheelchair"></i> ข้อมูลประเภทความพิการ</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="row justify-content-center mb-3">
                                <div class="col-12 col-md-3 col-lg-2 col-sm-12"><a href="disabled_add.php" class="btn bg-gradient-primary btn-block"><i class="fa fa-plus"></i> เพิ่มประเภทความพิการ</a></div>
                            </div>
                            <hr>
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>ข้อมูลประเภทความพิการ</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <!-- V1.0.2 -->
                                    <?php
                                    require_once('api/disabled_type.php');
                                    $i = 1;
                                            ...
                                            <td>
                                                <div class="row justify-content-between align-items-center">
                                                    ...
                                                    <div class="d-flex justify-content-center mr-3">
                                                        <a href="disabled_edit.php?id=<?= $row[0] ?>" class="btn btn-sm bg-gradient-primary mr-2">แก้ไข</a>
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Swal.fire({
                    ...
                    location.href = "src/disabled_del_check.php?id=" + id;
                })
            }
        })
    }
