        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">จัดข้อมูลประเภทและบริการ</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="index.php">หน้าแรก</a></li>
                                <li class="breadcrumb-item active">จัดข้อมูลประเภทและบริการ</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="nav-icon fas fa-list"></i> ข้อมูลประเภทและบริการ</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="row justify-content-center mb-3">
                                <div class="col-12 col-md-3 col-lg-2 col-sm-12"><a href="manage_add.php" class="btn bg-gradient-primary btn-block"><i class="fa fa-plus"></i> เพิ่มประเภทและบริการ</a></div>
                            </div>
                            <hr>
                                            ...
                                            <td>
                                                <div class="row justify-content-between align-items-center">
                                                    ...
                                                    <div class="d-flex justify-content-center mr-3">
                                                        <a href="manage_edit.php?id=<?= $row[0] ?>" class="btn btn-sm bg-gradient-primary mr-2">แก้ไข</a>
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Swal.fire({
                    ...
                    location.href = "src/manage_del_check.php?id=" + id;
                })
            }
        })
    }
