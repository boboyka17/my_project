                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-maroon">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-plus"></i> แบบฟอร์มเพิ่มข้อมูลสมาชิก</a></h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form id="quickForm" action="src/user_add_check.php" method="post">
                                <div class="row">
                                    <div class="col-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            <label for="">ชื่อ</label>
                                            <input type="text" name="firstname" class="form-control form-control-border border-width-2" id="" placeholder="กรุุณาป้อนชื่อ" required>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="lastname" class="form-control form-control-border border-width-2" id="" placeholder="กรุุณาป้อนนามสกุล" required>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input id="user" name="user" type="text" class="form-control form-control-border border-width-2" onchange="isEng(this.value)" id="" placeholder="กรุุณาป้อนชื่อผู้ใช้" required>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input id="pass" name="pass" type="password" class="form-control form-control-border border-width-2" id="" placeholder="กรุุณาป้อนรหัสผ่าน" required>
                                        </div>
                                    </div>
                                    <!-- <div class="col-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select name="position" id="" class="custom-select form-control-border border-width-2" required>
                                                ...
                                                <option value="1">พัฒนาสังคมและมั่นคงของมนุษย์จังหวัดสุราษฎร์ธานี</option>
                                                <option value="2">ผู้อำนวยการศูนย์บริการคนพิการจังหวัด สุราษฎร์ธานี</option>
                                                <option value="3">เจ้าหน้าที่นิติกร</option>
                                                <option value="4">เจ้าหน้าที่พัฒนาสังคม</option>
                                                <option value="5">เจ้าหน้าที่นักสังคมสงเคราะห์</option>
                                                <option value="6">เจ้าหน้าที่นักวิเคราะห์นโยบายและแผน</option>
                                            </select>
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input name="phone" type="text" class="form-control form-control-border border-width-2" placeholder="xxx-xxx-xxxx" data-inputmask="'mask': ['999-999-9999']" data-mask required>
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input name="email" type="text" class="form-control form-control-border border-width-2" placeholder="กรุณาป้อนอีเมล" required>
                                    ...
                                    <div class="col-12 col-md-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <select name="permission" id="" class="custom-select form-control-border border-width-2" required>
                                                ...
                                                <option value="G">ผู้บริหาร</option>
                                            </select>
