        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">แก้ไขมูลประเภทและบริการ</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="index.php">หน้าแรก</a></li>
                                <li class="breadcrumb-item active"> <a href="manage_views.php"> จัดข้อมูลประเภทและบริการ</a></li>
                                <li class="breadcrumb-item active">แก้ไขข้อมูลประเภทและบริการ</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-maroon">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-plus"></i> แบบฟอร์มแก้ไขมูลประเภทและบริการ</a></h3>
                        </div>
                        <?php
                        if (isset($_GET["id"])) {
                            $id = $_GET["id"];
                        ...
                        $result = get_manage_type($id, $conn);
                        $row = $result->fetch_array();
                        ?>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form id="quickForm" action="src/manage_edit_check.php?id=<?= $id ?>" method="post">
                                <div class="row">
